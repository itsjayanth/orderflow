...
// Thin wrapper around Radix's Tooltip primitive -- short delay, small
// dark-on-light (light-on-dark in .dark) surface, meant for icon-only
// button labels later phases add. `TooltipProvider` should wrap the app
// (or a page) once; each `Tooltip` below picks up its `delayDuration`.
