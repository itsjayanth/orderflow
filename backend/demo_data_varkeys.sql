...
DELETE FROM items WHERE merchant_id = '11111111-1111-1111-1111-111111111111';
...
DELETE FROM merchant_item_counters WHERE merchant_id = '11111111-1111-1111-1111-111111111111';
DELETE FROM merchant_customer_counters WHERE merchant_id = '11111111-1111-1111-1111-111111111111';
DELETE FROM merchant_order_counters WHERE merchant_id = '11111111-1111-1111-1111-111111111111';
...
VALUES
    ('33333333-3333-3333-3333-333333333301', '11111111-1111-1111-1111-111111111111', 1, 'Dosa & Crepes', 'Masala Dosa', 80.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333302', '11111111-1111-1111-1111-111111111111', 2, 'Dosa & Crepes', 'Plain Dosa', 60.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333303', '11111111-1111-1111-1111-111111111111', 3, 'Dosa & Crepes', 'Rava Masala Dosa', 90.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333304', '11111111-1111-1111-1111-111111111111', 4, 'Dosa & Crepes', 'Paneer Dosa', 110.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333305', '11111111-1111-1111-1111-111111111111', 5, 'Dosa & Crepes', 'Cheese Dosa', 100.00, true, NOW() - INTERVAL '80 days', NOW()),

    ('33333333-3333-3333-3333-333333333306', '11111111-1111-1111-1111-111111111111', 6, 'Idli & Vada', 'Idli (2 pcs)', 40.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333307', '11111111-1111-1111-1111-111111111111', 7, 'Idli & Vada', 'Medu Vada (2 pcs)', 50.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333308', '11111111-1111-1111-1111-111111111111', 8, 'Idli & Vada', 'Sambar Vada (2 pcs)', 55.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333309', '11111111-1111-1111-1111-111111111111', 9, 'Idli & Vada', 'Idli Vada Combo', 70.00, true, NOW() - INTERVAL '80 days', NOW()),

    ('33333333-3333-3333-3333-333333333310', '11111111-1111-1111-1111-111111111111', 10, 'Rice Items', 'Curd Rice', 60.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333311', '11111111-1111-1111-1111-111111111111', 11, 'Rice Items', 'Lemon Rice', 70.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333312', '11111111-1111-1111-1111-111111111111', 12, 'Rice Items', 'Sambar Rice', 80.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333313', '11111111-1111-1111-1111-111111111111', 13, 'Rice Items', 'Tamarind Rice', 75.00, true, NOW() - INTERVAL '80 days', NOW()),

    ('33333333-3333-3333-3333-333333333314', '11111111-1111-1111-1111-111111111111', 14, 'Chinese', 'Veg Fried Rice', 120.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333315', '11111111-1111-1111-1111-111111111111', 15, 'Chinese', 'Schezwan Fried Rice', 140.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333316', '11111111-1111-1111-1111-111111111111', 16, 'Chinese', 'Veg Hakka Noodles', 130.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333317', '11111111-1111-1111-1111-111111111111', 17, 'Chinese', 'Chilli Paneer', 180.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333318', '11111111-1111-1111-1111-111111111111', 18, 'Chinese', 'Gobi Manchurian', 150.00, true, NOW() - INTERVAL '80 days', NOW()),

    ('33333333-3333-3333-3333-333333333319', '11111111-1111-1111-1111-111111111111', 19, 'Beverages', 'Filter Coffee', 40.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333320', '11111111-1111-1111-1111-111111111111', 20, 'Beverages', 'Masala Tea', 30.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333321', '11111111-1111-1111-1111-111111111111', 21, 'Beverages', 'Buttermilk', 35.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333322', '11111111-1111-1111-1111-111111111111', 22, 'Beverages', 'Fresh Lime Soda', 45.00, true, NOW() - INTERVAL '80 days', NOW()),

    ('33333333-3333-3333-3333-333333333323', '11111111-1111-1111-1111-111111111111', 23, 'Desserts', 'Payasam', 60.00, true, NOW() - INTERVAL '80 days', NOW()),
    ('33333333-3333-3333-3333-333333333324', '11111111-1111-1111-1111-111111111111', 24, 'Desserts', 'Kesari', 50.00, true, NOW() - INTERVAL '80 days', NOW());

INSERT INTO merchant_item_counters (merchant_id, next_item_number)
VALUES ('11111111-1111-1111-1111-111111111111', 25);
...
VALUES
    ('44444444-4444-4444-4444-444444444401', '11111111-1111-1111-1111-111111111111', 1, '+919876501234', 'Rajesh Kumar', NOW() - INTERVAL '45 days', NOW() - INTERVAL '2 days', true),
    ('44444444-4444-4444-4444-444444444402', '11111111-1111-1111-1111-111111111111', 2, '+919876502345', 'Priya Sharma', NOW() - INTERVAL '60 days', NOW() - INTERVAL '5 days', true),
    ('44444444-4444-4444-4444-444444444403', '11111111-1111-1111-1111-111111111111', 3, '+919876503456', 'Amit Patel', NOW() - INTERVAL '30 days', NOW() - INTERVAL '1 day', true),
    ('44444444-4444-4444-4444-444444444404', '11111111-1111-1111-1111-111111111111', 4, '+919876504567', 'Sneha Reddy', NOW() - INTERVAL '20 days', NOW() - INTERVAL '7 days', true),
    ('44444444-4444-4444-4444-444444444405', '11111111-1111-1111-1111-111111111111', 5, '+919876505678', 'Vikram Singh', NOW() - INTERVAL '15 days', NOW() - INTERVAL '3 days', true);

INSERT INTO merchant_customer_counters (merchant_id, next_customer_number)
VALUES ('11111111-1111-1111-1111-111111111111', 6);
...
SELECT
    ...
    (SELECT COUNT(*) FROM items WHERE merchant_id = '11111111-1111-1111-1111-111111111111') as items,
